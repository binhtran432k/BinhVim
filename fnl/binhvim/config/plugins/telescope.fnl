(fn keys []
  [{1 "<leader>,"
   ...
   {1 :<leader><space> 2 "<cmd>Telescope find_files<cr>" :desc "Find Files"}
   ;; find
   {1 :<leader>fb
    2 "<cmd>Telescope buffers sort_mru=true sort_lastused=true<cr>"
    :desc :Buffers}
   ...
   {1 :<leader>fr 2 "<cmd>Telescope oldfiles only_cwd=true<cr>" :desc :Recent}
   ;; git
   ...
   {1 :<leader>sa 2 "<cmd>Telescope autocommands<cr>" :desc "Auto Commands"}
   {1 :<leader>sb
     ...
     :defaults {:prompt_prefix " "
                ...
                :get_selection_window (fn []
                                        (let [wins (vim.api.nvim_list_wins)
                                          ...
                                          (table.insert wins 1 current-win)
                                          (var found-win? false)
                                          (var found-win 0)
