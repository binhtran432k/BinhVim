...
if (vim.fn.has("nvim-0.9.0") == 0) then
  ...
  local function _33_(...)
    return (require("binhvim.config.plugins.illuminate")).opts(...)
  end
  local function _34_(...)
    return (require("binhvim.config.plugins.illuminate")).config(...)
  end
  local function _35_(...)
    return (require("binhvim.config.plugins.bufremove")).keys(...)
  end
  local function _36_(...)
    return (require("binhvim.config.plugins.trouble")).opts(...)
  end
  local function _37_(...)
    return (require("binhvim.config.plugins.trouble")).keys(...)
  end
  local function _38_(...)
    return (require("binhvim.config.plugins.todo_comments")).keys(...)
  end
  local function _39_(...)
